...
variable "environment" {
  description = "Environment name. Must remain 'staging' for this root."
  type        = string

  validation {
    condition     = var.environment == "staging"
    error_message = "environment must be set to staging in the staging root."
  }
}

variable "location" {
  description = "Primary Azure region for staging resources."
  type        = string
}

variable "vnet_cidr" {
  description = "Address spaces for staging virtual network."
  type        = list(string)
}
